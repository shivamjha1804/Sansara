...
const HighlightsSection = () => {
  ...
  const amenities = {
    "Nature & Tranquility": {
      ...
      items: [
        {
          heading: "Reflexology Paths & Butterfly Gardens",
          description: "A walk through wellness",
        },
        {
          heading: "The Orchard & Nature Trails",
          description: "A green escape within your home",
        },
        {
          heading: "Riverside Ghats & Cabanas",
          description: "The perfect setting for quiet contemplation",
        },
      ],
    },
    "Water & Wellness": {
      ...
      items: [
        {
          heading: "Infinity-Edge Pool & Quiet Lagoon",
          description: "A sanctuary for relaxation",
        },
        {
          heading: "Reflective Pond & Plunge Pool",
          description: "Designed for calm and rejuvenation",
        },
        {
          heading: "Floating Deck & Poolside Lounges",
          description: "Unwind with the river as your backdrop",
        },
        {
          heading: "Professional Swimming Pool",
          description: "For serious swimmers, perfecting every stroke",
        },
      ],
    },
    "Play & Adventure": {
      title: "A Wonderland for Every Age",
      items: [
        {
          heading: "Kids' Pool & Water Slide",
          description: "Fun-filled aquatic adventures",
        },
        {
          heading: "Kids' Play Park",
          description: "Rock climbing wall & jungle gym",
        },
        {
          heading: "Open Lawn & Percussion Park",
          description: "Spaces that spark imagination",
        },
      ],
    },
    "Family & Leisure": {
      title: "Where moments turn into memories",
      items: [
        {
          heading: "Café & Alfresco Dining",
          description: "Riverside indulgences, all day long",
        },
        {
          heading: "Amphitheatre & Event Lawn",
          description: "A stage for unforgettable gatherings",
        },
        {
          heading: "Family Lounge & Multipurpose Hall",
          description: "For celebrations, stories & shared laughter",
        },
        {
          heading: "Library, Cards Room & Co-working Space",
          description: "Thoughtful spaces for work & play",
        },
      ],
    },
  };
      ...
      <div className="w-full max-w-6xl mx-auto py-20 -mt-20 relative font-radley ">
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 relative">
            {/* Center vertical divider line - pure white */}
            <div className="absolute hidden md:block h-full w-0.5 bg-white left-1/2 transform -translate-x-1/2 z-10"></div>

            {/* Left Column - darker blue */}
            <div className="bg-blue-300/70 py-8 text-sm">
              <CategorySection
                category="Nature & Tranquility"
                title={amenities["Nature & Tranquility"].title}
                items={amenities["Nature & Tranquility"].items}
              />

              {/* Horizontal divider - white line */}
              <div className="my-10 h-0.5 w-full bg-white"></div>

              <CategorySection
                category="Water & Wellness"
                title={amenities["Water & Wellness"].title}
                items={amenities["Water & Wellness"].items}
              />
            </div>

            {/* Right Column - lighter blue */}
            <div className="bg-blue-300/70 py-8 text-sm">
              {/* Horizontal divider - white line (added for mobile) */}
              <div className="md:hidden my-10 h-0.5 w-full bg-white"></div>

              <CategorySection
                category="Play & Adventure"
                title={amenities["Play & Adventure"].title}
                items={amenities["Play & Adventure"].items}
              />
              ...
              <CategorySection
                ...
                title={amenities["Family & Leisure"].title}
                items={amenities["Family & Leisure"].items}
              />
            </div>
          </div>
          ...
          <div className="text-center py-6 px-4 bg-blue-200/50">
            <p className="text-xl md:text-xl  text-gray-800">
