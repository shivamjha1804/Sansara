...
const FixedButtonMenu = ({ setShowModal }) => {
  ...
  return (
    <div className="fixed z-50 bottom-0 left-0 right-0 md:bottom-auto md:left-auto md:right-0 md:top-1/3 flex flex-row md:flex-col justify-around md:justify-start md:gap-4 bg-white md:bg-transparent p-3 md:p-0 shadow-md md:shadow-none">
      {/* Call Us Button */}
      <div
      ...
      >
        ...
        >
          ...
          <span className="md:hidden text-sm font-medium px-3 py-2 tracking-wide">
            Call Us
          </span>
        </button>
      </div>
      ...
      >
        ...
        >
          ...
          {/* Show text only on mobile */}
          <span className="md:hidden text-sm font-medium px-4 py-2 tracking-wide">
            Download Brochure
          </span>
        </button>
      </div>
